        ...
        <div class="-mx-4 flex flex-wrap">
          <div class="w-full px-4 lg:w-8/12">
            <div class="relative mb-8 h-[370px] md:h-[480px]">
              <img src="./about-us.webp" alt="product" class="h-full w-full object-cover object-center" loading="lazy"/>

              {/* <div class="absolute left-0 top-0 flex h-full w-full items-center px-8 md:px-12">
                <div class="max-w-[420px]">
                  <h3>
                    <a href="javascript:void(0)" class="mb-5 block text-2xl font-bold text-dark hover:text-primary sm:text-4xl">
                      Mega Sale Up To 50% Off For All
                    </a>
                  </h3>
                  <p class="mb-9 text-base text-body-color">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    Vestibulum ornare vestibulum mollis. Nam vitae augue purus.
                    Integer ac accumsan nunc.
                  </p>
                  <a href="javascript:void(0)" class="inline-flex items-center justify-center rounded-md bg-primary px-7 py-[13px] text-center text-base font-medium text-white hover:bg-blue-dark">
                    Grab The Offer
                  </a>
                </div>
              </div> */}
            ...
            <div class="-mx-4 flex flex-wrap">
              <div class="w-full px-4 md:w-1/2 lg:w-full">
                <div class="relative mb-8 h-[223px]">
                  <img src="./about-us-2.webp" alt="product" class="h-full w-full object-cover object-center" loading="lazy"/>

                  {/* <div class="absolute left-0 top-0 flex h-full w-full items-end justify-end p-6 sm:p-9">
                    <div class="max-w-[180px] text-right">
                      <h3>
                        <a href="javascript:void(0)" class="mb-3 block text-xl font-bold text-dark hover:text-primary xl:text-2xl">
              ...
              <div class="w-full px-4 md:w-1/2 lg:w-full">
                <div class="relative mb-8 h-[223px]">
                  <img src="./about-us-3.webp" alt="product" class="h-full w-full object-cover object-center" loading="lazy"/>
              ...
              <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                <div className="mb-5 flex lg:mb-0">
                  ...
                  <div>
                    ...
                    <p className="text-base text-white/70">chhay.vivodin@ics-skillfulparenting.org</p>
                    <p className="text-base text-white/70">
                    yang.lai@ics-skillfulparenting.org
                    </p>
                  </div>
                </div>
              </div>
              <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                <div className="mb-5 flex lg:mb-0">
                  ...
                  <div>
                    ...
                    <p className="text-base text-white/70">(+855) 12 520 663</p>
                  </div>
                </div>
              </div>
              <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                  ...
                  <div className="w-full px-4 md:w-1/2">
                    <div className="mb-7">
                      <input
                        ...
                        className="dark:border-dark-3 dark:text-dark-6 w-full border border-stroke bg-transparent px-5 py-[17px] text-body-color outline-none focus:border-primary dark:focus:border-primary"
                      />
                    </div>
                  </div>
                  <div className="w-full px-4 md:w-1/2">
                  ...
                  <div className="w-full px-4">
                    <div className="mb-7">
                      <textarea
                        ...
                        rows="6"
                        className="dark:border-dark-3 dark:text-dark-6 w-full resize-none border border-stroke bg-transparent px-5 py-[17px] text-body-color outline-none focus:border-primary dark:focus:border-primary"
                      ></textarea>
                    </div>
                  </div>
