...
export function CarouselComponent() {
  ...
  return (
    <section className="container mx-auto py-12 px-5 mt-36" data-aos="zoom-in">
      <Carousel
            ...
            <div className="absolute inset-0 bg-black/75 flex items-end justify-center p-4">
              <div className="min-w-[280px] max-w-md md:max-w-lg lg:max-w-xl mx-auto w-full text-center">
                <Typography
                  variant="h3"
                  color="white"
                  className="mb-4 font-bold"  data-aos="flip-down"
                >
                  {slide.title}
                </Typography>
                <Typography
                  variant="lead"
                  color="white"
                  className="opacity-80 mb-5 leading-relaxed" data-aos="flip-down"
                >
                  {slide.description}
                </Typography>
              </div>
