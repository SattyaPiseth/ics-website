...
export default function StickyBar({
  ...
  return (
    <>
      {isVisible && (
        <section
          className={`border-b border-stroke bg-gray-1 px-3 py-2 sm:px-4 sm:py-3 dark:border-dark-3 dark:bg-dark-2 font-poppins transition-opacity duration-${transitionDuration} ease-in-out ${
        ...
        >
          <div className="container">
            <div className="relative flex items-center justify-center text-center space-x-3">
              ...
              <button
                onClick={handleClose}
                className="flex items-center justify-center w-5 h-5 sm:w-6 sm:h-6 text-dark-6 duration-200 hover:text-dark dark:hover:text-white"
