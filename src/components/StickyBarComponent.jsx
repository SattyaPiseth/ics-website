          ...
          <div className="container">
            <div className="relative flex items-center justify-center text-center space-x-3">
              ...
              <NavLink
                ...
                className={`text-xs sm:text-sm font-medium text-dark dark:text-white overflow-hidden whitespace-nowrap text-ellipsis group-hover:text-primary ${fontClass}`}
                style={{ fontSize: "calc(0.9rem + 0.01rem)" }} // Customize text size here
              >
                {message}
              </NavLink>
              <button
