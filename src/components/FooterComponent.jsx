      ...
      <footer className="relative z-10 bg-white pb-10 pt-20 dark:bg-dark lg:pb-20 lg:pt-[120px] font-poppins">
        <section className="container mx-auto">
          <div className="-mx-4 flex flex-wrap justify-center">
            ...
            {/* Social Media Follow */}
            <div class="w-full px-4 sm:w-1/2 lg:w-3/12 mt-10 sm:mt-0">
              <div class="mb-10 w-full">
                <h4 class="mb-9 text-lg font-semibold text-dark dark:text-white text-center sm:text-left flex justify-center sm:justify-center md:justify-center lg:justify-start overflow-x-auto">
                  Follow Us On
                </h4>
                <div class="mb-6 flex items-center overflow-x-auto justify-center sm:justify-center md:justify-center lg:justify-start">
                  <a
